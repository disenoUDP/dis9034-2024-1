...
function draw() {
  ...
  //quiero combinar las imagenes de background e img0, utilizaré la referencia de blend https://p5js.org/es/reference/#/p5/blend o averiguar como agregar el valor alfa para quitarle opacidad
  image(img0, 0, 0, 405, 503);
  image(img1, 550, 400, 405, 503);
}
