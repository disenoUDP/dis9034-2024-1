...
- Comencé a investigar cómo funcionaba y de qué manera podía aplicar esta herramienta, utilizando el video tutorial de [The Coding Train](https://thecodingtrain.com/) llegando a las siguientes pruebas:
