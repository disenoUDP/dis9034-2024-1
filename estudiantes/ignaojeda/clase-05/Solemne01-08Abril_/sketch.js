...
// caja 1
  push();
  translate(-200, 0, 0);
// función que permite que las cajas roten en el eje x en la caja 1
  rotateX(frameCount * velocidad);
// función que permite que las cajas roten en el eje y en la caja 1
...
// caja 2
  push();
  translate(200, 0, 0);
  // función que permite que las cajas roten en el eje x en la caja 2
  rotateX(frameCount * velocidad);
  // función que permite que las cajas roten en el eje y en la caja 2
  rotateY(frameCount * velocidad);
  texture(img1);
