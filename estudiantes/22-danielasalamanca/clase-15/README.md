...
```
#### function preload ()
3. cargamos las imágenes que vamos a utilizar, que son: el logo, el cuerpo del oso, la sombra, 6 poleras, 5 pantalones y 4 zapatitos
```javascript
...
```
#### function setup ()
5. creamos un canvas de 700x560 píxeles
```js
function setup() {
...
#### function draw()
9. definimos el color de fondo `background(217, 239, 86);`
...
```
18. repetimos los pasos 16 y 17 con los pantalones y los zapatitos
```js
